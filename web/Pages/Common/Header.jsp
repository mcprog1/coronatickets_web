<%-- 
    Document   : Header
    Created on : 5/10/2022, 08:47:20 PM
    Author     : Nico
--%>
...
<style>
    ...
    input[class='switch-input']:checked + .slider {
        background-color: #2196F3;
    }

    input[class='switch-input']:focus + .slider {
        box-shadow: 0 0 1px #2196F3;
    }

    input[class='switch-input']:checked + .slider:before {
